function TodayList() {
    return (
        <div className="w-2/5 bg-base-100 px-[2rem] py-[1rem] border-1 rounded-lg border-base-content h-full">
            <span>今日行程</span>
            <section className="grid gap-[1rem] list">
                <div className="list-row py-2 px-6 border-1 rounded-lg border-base-content">
                    <div className="flex flex-row gap-[0.5rem] list-col-grow">
                        <span>。</span>
                        <span>9:00</span>
                        <p>title</p>
                    </div>
